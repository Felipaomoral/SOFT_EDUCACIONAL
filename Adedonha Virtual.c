...
void intrucoes() {
    ...
    printf ("==                                                                                            		==\n");
    printf ("==                                                                                             		==\n");
    printf ("==                 INSTRUÇÕES DO JOGO ADEDONHA VIRTUAL		                         					==\n");
	printf ("== 																									==\n");
    printf ("==   *  Para jogar, inicialmente você precisa informar a quantidade de participantes;       		==\n");
    printf ("==   *  O progrmama sorteará a letra que os joadores deverão preencher sua lista;              		==\n");
...
void validacao(int qt_jogadores){
    ...
    /*Inicializando array da pontuação*/
    ...
    for (i=1; i<=qt_jogadores; i++){
        ...
        for (j=1; j<=qt_jogadores; j++){
            ...
            if(i!=j){     /* Validção pra nÃ£o comparar a resposta do jogador com a propria resposta */
        ...
        printf ("PONTUACÃO DO JODADOR %d: %d\n", i, pontuacao[i]);
    }
}
...
int main() {
	...
	printf("    Para ir direto para jogo, informe opção 1;\n");
	printf("    Para ver as instrucoes do jogo, informe opção 2;\n");
